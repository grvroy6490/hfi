<!---------------------------
            Checkout Multistep - Program Details Page
        ------------------------------>
                    ...
                    <div class="col-12">
                        <div class="checkout-flow">
                            ...
                            <div class="back_navigation">
                                <a href="<?php echo base_url(); ?>courses/all-courses" class="checkout-back-link body-small"
                                   >Back</a>
                            </div>
                                ...
                                <aside class="checkout-summary">
                                    <div class="checkout-summary-card">
                                        ...
                                        <div class="checkout-summary-body">
                                            ...
                                            <a href="<?php echo base_url(); ?>checkout/account-details" class="checkout-action checkout-action-primary checkout-summary-cta body-small">Continue to Secure your Seat</a>
