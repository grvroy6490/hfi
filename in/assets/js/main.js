...
(function () {
    ...
    const logos = [
        // APAC
        { image: baseURL + "assets/images/logos/APAC/Banglalink Digital Communication Ltd.png", region: "apac", alt: "Banglalink Digital Communication Ltd" },
        { image: baseURL + "assets/images/logos/APAC/BDO_Unibank.png", region: "apac", alt: "BDO Unibank" },
        { image: baseURL + "assets/images/logos/APAC/Cebu-Pacific.png", region: "apac", alt: "Cebu-Pacific" },
        { image: baseURL + "assets/images/logos/APAC/Cimb Bank Berhad.png", region: "apac", alt: "Cimb Bank Berhad" },
        { image: baseURL + "assets/images/logos/APAC/DBS Bank Limited.png", region: "apac", alt: "DBS Bank Limited" },
        { image: baseURL + "assets/images/logos/APAC/Globe Telecom.png", region: "apac", alt: "Globe Telecom" },
        { image: baseURL + "assets/images/logos/APAC/Manulife.png", region: "apac", alt: "Manulife" },
        { image: baseURL + "assets/images/logos/APAC/Maybank Singapore Limited.png", region: "apac", alt: "Maybank Singapore Limited" },
        { image: baseURL + "assets/images/logos/APAC/Metrobank.png", region: "apac", alt: "Metrobank" },
        { image: baseURL + "assets/images/logos/APAC/NTUC LearingHub.png", region: "apac", alt: "NTUC LearingHub" },
        { image: baseURL + "assets/images/logos/APAC/Union Bank of the Philippines.png", region: "apac", alt: "Union Bank of the Phillips" },

        // EU
        { image: baseURL + "assets/images/logos/EU/Air_France.png", region: "eu", alt: "Air France" },
        { image: baseURL + "assets/images/logos/EU/Bayer.png", region: "eu", alt: "Bayer" },
        { image: baseURL + "assets/images/logos/EU/Capegemini.png", region: "eu", alt: "Capegemini" },
        { image: baseURL + "assets/images/logos/EU/Danske-Bank.png", region: "eu", alt: "Danske-Bank" },
        { image: baseURL + "assets/images/logos/EU/Deloitte.png", region: "eu", alt: "Deloitte" },
        { image: baseURL + "assets/images/logos/EU/Ericsson.png", region: "eu", alt: "Ericsson" },
        { image: baseURL + "assets/images/logos/EU/GE Healthcare.png", region: "eu", alt: "GE Healthcare" },
        { image: baseURL + "assets/images/logos/EU/GlaxoSmithKline.png", region: "eu", alt: "GlaxoSmithKline" },
        { image: baseURL + "assets/images/logos/EU/Old Mutual.png", region: "eu", alt: "Old Mutual" },
        { image: baseURL + "assets/images/logos/EU/Rabobank.png", region: "eu", alt: "Rabobank" },
        { image: baseURL + "assets/images/logos/EU/Royal Dutch Airlines.png", region: "eu", alt: "Royal Dutch Airlines" },

        // IN
        { image: baseURL + "assets/images/logos/IN/Accenture.png", region: "in", alt: "Accenture Pvt Ltd" },
        { image: baseURL + "assets/images/logos/IN/Aditya_Birla_Group.png", region: "in", alt: "Aditya Birla Group" },
        { image: baseURL + "assets/images/logos/IN/Boston Consulting Group.png", region: "in", alt: "Boston Consulting Group" },
        { image: baseURL + "assets/images/logos/IN/BSH.png", region: "in", alt: "BSH" },
        { image: baseURL + "assets/images/logos/IN/Citiustech.png", region: "in", alt: "Citiustech" },
        { image: baseURL + "assets/images/logos/IN/Cognizant.png", region: "in", alt: "Cognizant" },
        { image: baseURL + "assets/images/logos/IN/HDFC Bank.png", region: "in", alt: "HDFC Bank" },
        { image: baseURL + "assets/images/logos/IN/ICICI_Bank_Logo.png", region: "in", alt: "ICICI Bank Logo" },
        { image: baseURL + "assets/images/logos/IN/IDFC Bank.png", region: "in", alt: "IDFC Bank" },
        { image: baseURL + "assets/images/logos/IN/Publicis Sapient.png", region: "in", alt: "Publicis Sapient" },
        { image: baseURL + "assets/images/logos/IN/Siemens.png", region: "in", alt: "Siemens" },
        { image: baseURL + "assets/images/logos/IN/TCS.png", region: "in", alt: "TCS" },
        { image: baseURL + "assets/images/logos/IN/Tech Mahindra.png", region: "in", alt: "Tech Mahindra" },
        { image: baseURL + "assets/images/logos/IN/Wells_Fargo.png", region: "in", alt: "Wells Fargo" },
        { image: baseURL + "assets/images/logos/IN/Wipro.png", region: "in", alt: "Wipro" },

        // ME
        { image: baseURL + "assets/images/logos/ME/DEWA.AE_BIG.png", region: "me", alt: "DEWA.AE BIG" },
        { image: baseURL + "assets/images/logos/ME/Ecobank.png", region: "me", alt: "Ecobank" },
        { image: baseURL + "assets/images/logos/ME/Emirates.png", region: "me", alt: "Emirates" },
        { image: baseURL + "assets/images/logos/ME/Masdar.png", region: "me", alt: "Masdar" },
        { image: baseURL + "assets/images/logos/ME/Navcon.png", region: "me", alt: "Navcon" },
        { image: baseURL + "assets/images/logos/ME/Qatar Islamic Bank.png", region: "me", alt: "Qatar Islamic Bank" },
        { image: baseURL + "assets/images/logos/ME/RTA.png", region: "me", alt: "RTA" },
        { image: baseURL + "assets/images/logos/ME/smart-dubai.png", region: "me", alt: "smart-dubai" },
        { image: baseURL + "assets/images/logos/ME/tsys.png", region: "me", alt: "tsys" },

        // NA
        { image: baseURL + "assets/images/logos/NA/3M.png", region: "na", alt: "3M" },
        { image: baseURL + "assets/images/logos/NA/Booz Allen Hamiliton.png", region: "na", alt: "Booz Allen Hamiliton" },
        { image: baseURL + "assets/images/logos/NA/California Department of Technology.png", region: "na", alt: "California Department of Technology" },
        { image: baseURL + "assets/images/logos/NA/Christiana Care.png", region: "na", alt: "Christiana Care" },
        { image: baseURL + "assets/images/logos/NA/City of San Antonio.png", region: "na", alt: "City of San Antonio" },
        { image: baseURL + "assets/images/logos/NA/CVS Health.png", region: "na", alt: "CVS Health" },
        { image: baseURL + "assets/images/logos/NA/FedEx.png", region: "na", alt: "FedEx" },
        { image: baseURL + "assets/images/logos/NA/Florida Power & Light.png", region: "na", alt: "Florida Power & Light" },
        { image: baseURL + "assets/images/logos/NA/National Park Service (NPS).png", region: "na", alt: "National Park Service (NPS)" },
        { image: baseURL + "assets/images/logos/NA/State Farm.png", region: "na", alt: "State Farm" },
        { image: baseURL + "assets/images/logos/NA/UBS.png", region: "na", alt: "UBS" },
        { image: baseURL + "assets/images/logos/NA/Veritas_Technologies.png", region: "na", alt: "Veritas Technologies" },
        { image: baseURL + "assets/images/logos/NA/Verizon_Wireless_logo.png", region: "na", alt: "Verizon Wireless logo" },

        // SA
        { image: baseURL + "assets/images/logos/SA/Absa Bank.png", region: "sa", alt: "Absa Bank" },
        { image: baseURL + "assets/images/logos/SA/Capitec_Bank.png", region: "sa", alt: "Capitec Bank" },
        { image: baseURL + "assets/images/logos/SA/Discovery_Holding_Company.png", region: "sa", alt: "Discovery Holding Company" },
        { image: baseURL + "assets/images/logos/SA/Ecobank.png", region: "sa", alt: "Ecobank" },
        { image: baseURL + "assets/images/logos/SA/First National Bank.png", region: "sa", alt: "First National Bank" },
        { image: baseURL + "assets/images/logos/SA/Investec.png", region: "sa", alt: "Investec" },
        { image: baseURL + "assets/images/logos/SA/Multichoice Group.png", region: "sa", alt: "Multichoice Group" },
        { image: baseURL + "assets/images/logos/SA/Nedbank_idvPPE6CB0_1.png", region: "sa", alt: "Nedbank idvPPE6CB0 1" },
        { image: baseURL + "assets/images/logos/SA/Old Mutual.png", region: "sa", alt: "Old Mutual" },
        { image: baseURL + "assets/images/logos/SA/Standard Bank Group.png", region: "sa", alt: "Standard Bank Group" },
        { image: baseURL + "assets/images/logos/SA/Vodacom.png", region: "sa", alt: "Vodacom" },
        { image: baseURL + "assets/images/logos/SA/Momentum Inc..png", region: "sa", alt: "Momentum Inc." }
