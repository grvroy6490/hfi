                        ...
                        <div class="checkout-flow">
                            ...
                            <nav class="checkout-steps" aria-label="Checkout progress">
                                <ol class="checkout-steps-list">
                                    <li class="checkout-step is-complete" data-step-nav="0">
                                    ...
                                    <li class="checkout-step is-complete" data-step-nav="1">
                                        <div class="checkout-step-button">
                                            <span class="checkout-step-icon" aria-hidden="true">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li class="checkout-step is-active" data-step-nav="2">
                            ...
                            <div class="back_navigation">
                                <a href="<?php echo base_url(); ?>checkout/account-details" class="checkout-back-link body-small"
                                   >Back</a>
                            </div>
                                ...
                                <aside class="checkout-summary">
                                    <div class="checkout-summary-card">
                                        ...
                                        <div class="checkout-summary-body">
                                            ...
                                            <a href="<?php echo base_url(); ?>checkout/confirmation" class="checkout-action checkout-action-primary checkout-summary-cta body-small">Complete Payment</a>
